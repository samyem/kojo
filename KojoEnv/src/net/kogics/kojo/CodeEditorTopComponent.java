...
//        add(panel, BorderLayout.CENTER);
    ...
    /**
     * Obtain the CodeEditorTopComponent instance. Never call {@link #getDefault}
     * directly!
     */
...
//        }
    ...
    static class CodeEditorPopupMenu extends JPopupMenu {
        ...
        public CodeEditorPopupMenu() {
            ...
            stagingCb.setText(NbBundle.getMessage(klass, "S_StagingMode"));
            stagingCb.setToolTipText(NbBundle.getMessage(klass, "S_StagingModeTT"));
            stagingCb.setActionCommand("Staging");
            add(stagingCb);
            final JCheckBoxMenuItem mwCb = new JCheckBoxMenuItem(switcher);
            mwCb.setText(NbBundle.getMessage(klass, "S_MwMode"));
            mwCb.setToolTipText(NbBundle.getMessage(klass, "S_MwModeTT"));
            ...
            clr.setText(NbBundle.getMessage(klass, "S_ClearEditor"));
...
//            }
        ...
        private void addFontMenuItem() {
            Class klass = getClass();
            Action action = new AbstractAction(NbBundle.getMessage(klass, "S_AdvancedOptions")) {
            ...
            JMenu experimental = new JMenu(NbBundle.getMessage(klass, "S_Expt"));
